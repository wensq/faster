/**
 * StringUtils.java was created on 2007-8-15 23:29:19
 *
 * Copyright (c) 2006 EASTCOM Software Technology Co.,Ltd. All rights reserved.
 */
...
public class StringUtils {
	 ...
	 * @return 布尔值
	 */
	public static boolean booleanFromString(String boolString,
	 ...
	 * @return 布尔值
	 */
	public static boolean booleanFromStringIgnoreCase(String boolString,
			String... trueDisplayStrings) {
		for (String trueDisplayString : trueDisplayStrings) {
			if (boolString.equals(trueDisplayString)) {
				return true;
	...
	public static boolean booleanFromOnOffString(String boolString) {
		return booleanFromStringIgnoreCase(boolString, "On");
	}
